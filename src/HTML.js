    ...
    parseDOM(dom, props = this.props) {
        ...
        const parser = new Parser(
            new DomHandler((_err, dom) => {
                let RNElements = this.mapDOMNodesTORNElements(
                    dom,
                    false,
                    props
                );
                ...
                if (
                    ...
                    Object.keys(wrapperStyles).forEach((styleKey) => {
                        ...
                        if (TextOnlyPropTypes.indexOf(styleKey) !== -1) {
                            textChildrenInheritedStyles[styleKey] =
                                wrapperStyles[styleKey];
    ...
    renderRNElements(
        ...
        return RNElements && RNElements.length
            ? RNElements.map((element, index) => {
                  ...
                  const classStyles = _getElementClassStyles(
                      attribs,
                      classesStyles
                  );
